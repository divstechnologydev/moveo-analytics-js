        ...
        setupClickTracking() {
            document.addEventListener('click', (event) => {
                ...
                if (!['a', 'button', 'input', 'select'].includes(elementType)) {
                    target = target.closest('a, button, input[type="button"], input[type="submit"], select');
                    if (!target) return;
        ...
        setupScrollTracking() {
            ...
            window.addEventListener('scroll', () => {
                ...
                scrollTimeout = setTimeout(() => {
                    ...
                    const scrollPercentage = Math.round((scrollPosition / (document.documentElement.scrollHeight - window.innerHeight)) * 100);
